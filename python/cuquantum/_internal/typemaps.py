...
from cuquantum.bindings._utils import ComputeType, cudaDataType
...
def create_cuda_compute_type_map(cuda_compute_type_enum_class):
    ...
    """
    cuda_compute_type_pattern = re.compile(r'COMPUTE_(?:(?P<width>\d+)(?P<type>F|I|U|BF)|(?P<tf32>TF32|3XTF32))')
