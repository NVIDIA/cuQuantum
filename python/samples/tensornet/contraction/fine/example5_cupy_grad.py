...
from cuquantum.tensornet import Network, tensor_qualifiers_dtype
...
qualifiers = np.zeros(3, dtype=tensor_qualifiers_dtype)

# require gradient computation of all inputs
qualifiers[:]['requires_gradient'] = 1

# create a network
tn = Network("abc,bcd,dce->ae", a, b, c, qualifiers=qualifiers)
