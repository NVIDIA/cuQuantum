...
gate_x = cp.asarray([[0, 1], [1, 0]], dtype='complex128', order='F')
gate_x_strides = 0
...
for i in range(1, num_qubits):
    tensor_id = cutn.state_apply_controlled_tensor_operator(
            handle, quantum_state, 1, (i-1,), 0, 
            1, (i,), gate_x.data.ptr, 
            gate_x_strides, 1, 0, 1)
