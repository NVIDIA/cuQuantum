...
#################
cp.random.seed(SEED)
A_d = cp.random.random((np.prod(extent_A),), dtype=np.float64)
B_d = cp.random.random((np.prod(extent_B),), dtype=np.float64)
C_d = cp.random.random((np.prod(extent_C),), dtype=np.float64)
D_d = cp.random.random((np.prod(extent_D),), dtype=np.float64)
E_d = cp.random.random((np.prod(extent_E),), dtype=np.float64)
F_d = cp.random.random((np.prod(extent_F),), dtype=np.float64)
O_d = cp.zeros((np.prod(extent_O),), dtype=np.float64)
