...
class TestMathMode:
    ...
    def test_math_mode(self, handle):
        assert cusv.get_math_mode(handle) == cusv.MathMode.DEFAULT

        cusv.set_math_mode(handle, cusv.MathMode.ALLOW_FP32_EMULATED_BF16X9)
        assert cusv.get_math_mode(handle) == cusv.MathMode.ALLOW_FP32_EMULATED_BF16X9

        cusv.set_math_mode(handle, cusv.MathMode.DISALLOW_FP32_EMULATED_BF16X9)
        assert cusv.get_math_mode(handle) == cusv.MathMode.DISALLOW_FP32_EMULATED_BF16X9
